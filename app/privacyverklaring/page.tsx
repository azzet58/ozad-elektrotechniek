        ...
        <FadeIn>
          ...
          <div className="mx-auto max-w-4xl space-y-12 font-medium text-neutral-500 md:px-12 2xl:space-y-24 2xl:px-0 2xl:text-2xl">
            ...
            <section className="space-y-4 2xl:space-y-8">
              ...
              <p>
                Özad Elektrotechniek B.V. bewaart uw persoonsgegevens niet
                langer dan strikt nodig is om de doelen te realiseren waarvoor
            ...
            <section className="space-y-4 2xl:space-y-8">
              ...
              <p>
                Özad Elektrotechniek B.V. verkoopt uw gegevens niet aan derden
                en zal deze uitsluitend verstrekken indien dit nodig is voor de
                ...
                zorgen voor eenzelfde niveau van beveiliging en
                vertrouwelijkheid van uw gegevens. Özad Elektrotechniek B.V.
            ...
            <section className="space-y-4 2xl:space-y-8">
              ...
              <p>
                ...
                door Özad Elektrotechniek B.V. en heeft u het recht op
              ...
              <p>
                ...
                volgende link:{" "}
                <Link
                  className="break-all text-blue-600 transition-colors hover:text-black"
            ...
            <section className="space-y-4 2xl:space-y-8">
              ...
              <p>
                ...
                wijziging tegen te gaan. Als u het idee heeft dat uw gegevens
                toch niet goed beveiligd zijn of er aanwijzingen zijn van
                misbruik, neem dan contact op via het{" "}
                <Link
                  className="text-blue-600 transition-colors hover:text-black"
                  href="/contact"
                >
