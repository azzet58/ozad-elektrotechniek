      ...
      <div className="mx-auto max-w-4xl space-y-24 text-2xl font-medium text-neutral-500">
        <section>
          <p>
            ...
            , zoals deze beschikbaar is gesteld door Özad Elektrotechniek B.V..
            In deze disclaimer geven wij aan onder welk voorbehoud wij de
        ...
        <section className="space-y-8">
          ...
          <p>
            ...
            Elektrotechniek B.V. is het niet toegestaan tekst, fotomateriaal of
            andere materialen op deze website her te gebruiken. Het
        ...
        <section className="space-y-8">
          ...
          <p>
            ...
            wel typefouten, vormen nooit een aanleiding om een contract dan wel
            overeenkomst met Özad Elektrotechniek B.V. te mogen claimen of te
            veronderstellen.
          </p>
          <p>
            ...
            inhoud op deze website onvolledig en of onjuist zijn, dan kunnen wij
        ...
        <section className="space-y-8">
          ...
          <p>
            Mocht deze disclaimer wijzigen, dan vindt u de meest recente versie
            van de disclaimer van{" "}
            <Link
              className="text-blue-600 transition-colors hover:text-black"
              href="https://www.ozadelektrotechniek.nl"
            >
