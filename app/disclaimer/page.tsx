          ...
          <div className="mx-auto max-w-4xl space-y-12 font-medium text-neutral-500 md:px-12 2xl:space-y-24 2xl:px-0 2xl:text-2xl">
            ...
            <section className="space-y-4 2xl:space-y-8">
              ...
              <p>
                ...
                deze informatie niet kopieert, verspreidt of op een andere
            ...
            <section className="space-y-4 2xl:space-y-8">
              ...
              <p>
                ...
                Fouten die daarbij ontstaan en herkenbaar zijn als programmeer
                dan wel typefouten, vormen nooit een aanleiding om een contract
                dan wel overeenkomst met Özad Elektrotechniek B.V. te mogen
