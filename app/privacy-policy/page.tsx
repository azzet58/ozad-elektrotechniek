      ...
      <div className="mx-auto max-w-4xl space-y-24 text-2xl font-medium text-neutral-500">
        ...
        <section className="space-y-8">
          ...
          <p>
            ...
            gebruik maakt van onze diensten en/of omdat u deze gegevens zelf aan
            ons verstrekt.
          </p>
          <ul className="list-inside list-disc">
            <p>
        ...
        <section className="space-y-8">
          ...
          <p>
            Özad Elektrotechniek B.V. verwerkt ook persoonsgegevens als wij hier
        ...
        <section className="space-y-8">
          ...
          <p>
            ...
            dan strikt nodig is om de doelen te realiseren waarvoor uw gegevens
            worden verzameld.
          </p>
        </section>
        <section className="space-y-8">
          ...
          <p>
            ...
            gegevens. Özad Elektrotechniek B.V. blijft verantwoordelijk voor
            deze verwerkingen.
          </p>
        </section>
        <section className="space-y-8">
