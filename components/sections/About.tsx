...
export default function About() {
  return (
    <section
      data-nav-theme="dark"
      className="relative pt-12 pb-12 md:pt-24 md:pb-24 lg:py-36 2xl:py-64"
    >
      <div className="mx-auto max-w-[1700px] px-4 md:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-24 2xl:gap-48">
          <div className="space-y-12 2xl:space-y-24">
            <h2 className="text-3xl font-bold md:text-4xl 2xl:text-5xl">
          ...
          <div>
            <div className="relative h-64 w-full overflow-hidden rounded-md sm:h-80 md:h-96 lg:absolute lg:top-24 2xl:top-36 lg:right-8 lg:h-3/4 lg:w-[45%]">
              <ParallaxImage
